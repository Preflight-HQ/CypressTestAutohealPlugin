...
describe('test', () => {
  it('Login | YourWebApp', () => {
    cy.viewport(1440, 900);
    cy.initializeAutoheal('null');
    cy.visit('https://yourweb.app/#/login');
    cy.get('//h2[text()=" Sign in to your account "]/..//a', 2).click();
    cy.get('//label[text()="Email address"]/..//input', 3).type('{{generate.email}}');
    // cy.get('//label[text()="First name"]/..//input', 4).type('ter');
    // cy.get('//label[text()="Last name"]/..//input', 5).type('te');
